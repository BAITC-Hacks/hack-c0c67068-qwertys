# SAMAL — прогноз ветра в решение диспетчера
...
![Рабочий экран SAMAL: реальный прогноз и журнал агента](docs/demo/SAMAL-final-desktop.png)

Финальный интерфейс, 23.09.2026: сохранённый реальный LLM-запуск, 48 часов × 2 турбины = 96 строк. [Узкий экран](docs/demo/CLAUDE-FE-dashboard-narrow-500.png) · [История визуальной приёмки](docs/demo/CLAUDE-evidence.md). Значения на иллюстративной 3D-сцене лендинга не являются прогнозом.
...
| Финальный frontend `6ceab13`, ноутбук 2 | Чистый `npm ci`, **2/2 Node-теста**, TypeScript/Vite build, lint exit 0 |
