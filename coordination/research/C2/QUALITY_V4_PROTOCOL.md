...
Pre-run amendment15:47 following independent C5 review, before any real V4 fit: 5% fold/slice and0.01 absolute overall bias gates must pass against BOTH full and recent91-day curves. A required all/lead/highwind slice with fewer than100pairs is insufficient evidence and prevents promotion, rather than counting as PASS. Other low-count exploratory slices remain descriptive. Alpha re-fit semantics and zero-energy rule independently approved. Synthetic pipeline fixture initially supplied fewer than100outer rows and correctly failed; extend only the synthetic fixture, preserve failure evidence; real folds/counts unchanged.
