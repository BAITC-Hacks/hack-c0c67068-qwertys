...
## V5 bounded restart — final confirmed state 2026-09-23 17:41 UTC+5

User-authorized exception to STOPSEARCH for one <=12-minute cycle, <=$2 incremental/shared$50 ceiling. Separate research protocol4e4cd06; actual training was **not started** because CUDA probe did not return before the3-minute readiness gate. Existing47y85unm3 Starting17:16:12, Running17:16:23, Stop17:19:42, provider-confirmed **Stopped17:24:32**, before17:27:59 deadline. Conservative full-rate8m20s×$0.65/h estimate$0.0903, not settled cost. Fresh panelbalance$49.55 cannot isolate this cycle from preceding settlements. Disk$0.02/h continues pending specific irreversible-delete confirmation. No new machine/top-up/API calls/data upload. V1/demo unchanged. No further restart authorized in this cycle. Full evidence research/C2/QUALITY_V5_NO_GO.md and quality-v5-no-go.json. This final entry supersedes the old16:05 stopped timestamp for resource state; historical experiment records remain unchanged.
